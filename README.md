...
<!-- taskrail-size:start -->
<p align="center"><strong>⚡ Tiny framework footprint: ~215 KiB compressed / ~1132 KiB unpacked, with zero runtime npm dependencies.</strong></p>
<!-- taskrail-size:end -->
...
**Current TaskRail package footprint: ~215 KiB compressed / ~1132 KiB unpacked. Runtime npm dependencies: 0.**
