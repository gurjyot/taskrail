...
<!-- taskrail-size:start -->
<p align="center"><strong>⚡ Tiny framework footprint: ~236 KiB compressed / ~1245 KiB unpacked, with zero runtime npm dependencies.</strong></p>
<!-- taskrail-size:end -->
...
**Current TaskRail package footprint: ~236 KiB compressed / ~1245 KiB unpacked. Runtime npm dependencies: 0.**
