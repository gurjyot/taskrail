...
<!-- taskrail-size:start -->
<p align="center"><strong>⚡ Tiny framework footprint: ~236 KiB compressed / ~1242 KiB unpacked, with zero runtime npm dependencies.</strong></p>
<!-- taskrail-size:end -->
...
| --- | --- |
| **Core package** | ~230 KiB compressed / ~1211 KiB unpacked |
...
**Current TaskRail package footprint: ~236 KiB compressed / ~1242 KiB unpacked. Runtime npm dependencies: 0.**
