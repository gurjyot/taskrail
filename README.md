...
<!-- taskrail-size:start -->
<p align="center"><strong>⚡ Tiny framework footprint: ~216 KiB compressed / ~1136 KiB unpacked, with zero runtime npm dependencies.</strong></p>
<!-- taskrail-size:end -->
...
**Current TaskRail package footprint: ~216 KiB compressed / ~1136 KiB unpacked. Runtime npm dependencies: 0.**
