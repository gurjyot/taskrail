...
<!-- taskrail-size:start -->
<p align="center"><strong>⚡ Tiny framework footprint: ~230 KiB compressed / ~1211 KiB unpacked, with zero runtime npm dependencies.</strong></p>
<!-- taskrail-size:end -->
...
**Current TaskRail package footprint: ~230 KiB compressed / ~1211 KiB unpacked. Runtime npm dependencies: 0.**
